...
tc.showWin=function (){
    ...
    let lower=document.getElementById("lower");
    lower.innerHTML=player.name+" wins";
    ...
    setTimeout(()=>{document.querySelector("#"+player.id+" .score").classList.remove("change");},500);//500
...
// tc.showChangedType=function (){}
 ...
 tc.showCurrentTurn=function (){
    ...
    setTimeout(()=>{
        tc.getInput(TTTAI.getComputerTurn(tc.arr,tc.player1.sign,tc.computerLevel));
    },500);//500
 }
